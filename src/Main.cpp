...
#define MYAPPLICATION_NAME L"Shooting gallery"

//пропроцессор - предварительная обработка кода(до компиляции)
//условная компиляция - обычное ветвление, которое описывается в директивах проепроцессора

//#define (определение)
//#ifdef 
//	определяем, будет ли выполняться участок кода между директивами
//#endif
